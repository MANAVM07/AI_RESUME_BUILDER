        ...
        <div className='space-y-4'>
            <div className='flex items-center justify-between'>
                ...
                <button disabled={isGenerating} onClick={generateSummary} className='flex items-center gap-2 px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
                    {isGenerating ? (<LoaderCircleIcon className='animate-spin size-4' />) : (
            ...
            <div className='mt-6'>
                <textarea
                    ...
                    rows="7"
                    className="w-full p-3 px-4 mt-2 border text-sm border-gray-300 rounded-lg focus:ring focus:ring-green-500 focus:border-green-500 outline-none transition-colors placeholder:text-gray-500 resize-none"
                ...
                <div className="bg-yellow-50 p-3 rounded-lg">
                    ...
                    >
                        <strong>Tip:</strong> Tip: Keep it concise (3-4 sentences) and focus on your most relevant achievements and skills.
                    </p>
                </div>

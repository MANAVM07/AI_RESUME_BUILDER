...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12' >
            ...
            <Badge/>
            <Title title={"Build your resume"} description={"ur streamlined process helps you create a professional resume in minutes with intelligent AI-powered tools and features."} />

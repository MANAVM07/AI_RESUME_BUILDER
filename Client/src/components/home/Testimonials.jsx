    ...
    const cardsData = [
        {
            ...
            name: 'Briar Martin',
            handle: 'Amazon',
            logo: 'https://icon2.cleanpng.com/20190731/yrb/kisspng-gift-card-jvck-velvet-underground-jw-music-1713875057521.webp'
        },
        {
        ...
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    ...
                    <div className='flex items-center gap-2'><img src={card.logo} className='size-6 rounded-full' alt="" /><span className="text-xs text-slate-500">{card.handle}</span></div>
                </div>
            </div>
    ...
    return (
        <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12' >
            ...
            <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10  rounded-full px-6 py-1.5">
                <BookUserIcon width={18} className=' stroke-green-600' />

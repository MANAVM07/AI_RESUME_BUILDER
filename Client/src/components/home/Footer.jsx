...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="px-6 mt-24 md:px-16 lg:px-12 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10 bg-linear-to-r from-white via-green-200/60 to-white">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    ...
                    <div className="flex flex-col lg:items-center lg:justify-center">
                        <div className="flex flex-col text-sm space-y-2.5">
                            ...
                            <a className="hover:text-slate-600 transition" href="#">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span></a>
                    ...
                    <div className=''>
                        ...
                        <div className="text-sm space-y-6 max-w-sm">
                            ...
                            <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-green-50">
                                <input className="focus:ring-2 ring-green-600 outline-none w-full max-w-64 py-2 rounded px-2" type="email" placeholder="Enter your email" />
                                <button className="bg-green-600 px-4 py-2 text-white rounded">Subscribe</button>
                            </div>
                        </div>
                    </div>
                </div>
